                                                ...
                                                <div className="flex justify-between py-8">
                                                    <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                        <div className="nav-item">
                                                            <div className="text-button-uppercase pb-2">Fashion</div>
                                                            <ul>
                                                                <li>
                                                                    <div
                                                        ...
                                                        <div className="nav-item">
                                                            <div className="text-button-uppercase pb-2">Home Decor</div>
                                                            <ul>
                                                                <li>
                                                                    <div
                                                                        onClick={() => handleTypeClick('bedsheet')}
                                                                        className={`link text-secondary duration-300 cursor-pointer`}
                                                                    >
                                                                        Bed Sheet | curtains
                                                                    </div>
                                                                ...
                                                                <li>
                                                                    <div
                                                                        onClick={() => handleTypeClick('painting')}
                                                                        className={`link text-secondary duration-300 cursor-pointer`}
                                                                    >
                                                                        Paintings
                                                                    </div>
